...
const Header = ({ type }) => {
    ...
    return (
        <div className="bg-appBlue text-white flex justify-center relative">
            <div className={type === "list" ?  "w-full max-w-5xl mt-5 mr-0 mb-10 ml-0" : "w-full max-w-5xl mt-5 mr-0 mb-24 ml-0" }>
                    ...
                    <>
                        ...
                        <div className="h-14 bg-white border-solid border-[3px] border-[#febb02] flex items-center justify-around py-4 px-0 rounded-md absolute bottom-[-25px] w-full max-w-5xl">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                {
                                    openOptions &&
                                    <div className="absolute top-12 bg-white text-gray-400 rounded-md shadow-md z-10">
                            ...
                            <div className="flex items-center gap-3">
                                <span className="bg-[#0071c2] px-5 py-2 cursor-pointer" onClick={handleSearch}>Search</span>
                            </div>
                        </div>
                    </>
                }
